                        ...
                        <div class="slides">
                            <div class="overflow">
                                @foreach($photos as $photo)
                                    <img @class(['active' => $loop->first]) src="{{Storage::url($photo->path)}}" alt="Gallery photo." />
                                @endforeach
                            </div>
                        </div>
                    </div>
            ...
            <section id="testimonials">
                <div class="wrapper">
                    <div class="heading">
                        ...
                        <p>
                            Everyone loves OotM, students, coaches and parents
                            alike.
                        </p>
                    </div>
                    <article>
                    ...
                    <div class="grid">
                        <article>
                            <p class="quote">
                                The experience was truly eye-opening, and I'm
                                glad I participate in it, I will remember this
                        ...
                        <article>
                            <p class="quote">
                                Odyssey is a very fun activity as you can meet
                                new friends and meet new coaches.
                            </p>
                            <div class="author">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <article>
                            <p class="quote">
                                Odyssey helps to create new memories and have
                                wonderful experiences with friends and other
                                people.
                            </p>
                            <div class="author">
                                <svg
                        ...
                        <article>
                            <p class="quote">
                                I think Odyssey is very good because it opens
                                opportunities for you to be more independent.
                            </p>
                            <div class="author">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <article>
                            <p class="quote">
                                Odyssey of the Mind has helped me grow both as a
                                thinker, a team member, and as a person.
                            </p>
                            <div class="author">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <p>
                                    ...
                                    <br />
                                    <span>
                                        Alumni, Swiss Coaching Assistant
                                    </span>
                                </p>
                            </div>
                        </article>
                        <article>
                            <p class="quote">
                                I think that Odyssey of the Mind has helped me
                                learn and grow to become a more creative,
                                independent and overall interesting person.
                            </p>
                            <div class="author">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
