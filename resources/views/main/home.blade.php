<x-layout.root title="Home">
    ...
    <body class="main">
        ...
        <main id="home">
            <section id="hero">
                <div class="parallax">
                    <img src="/assets/hero.jpg" alt="Beautiful mountain-scape taken in the Alps." />
                </div>
                <div class="wrapper">
            ...
            <section id="about">
                <div class="wrapper">
                    ...
                    <img src="/assets/ootm.png" alt="Logo for Odyssey of the Mind International." />
                </div>
            </section>
            <section id="tagline">
                <div class="wrapper">
