<x-layout.root title="Home">
    ...
    <main id="home">
        <section id="hero">
            <div class="parallax">
                <img src="{{ Vite::asset("resources/images/hero.jpg") }}" alt="Mountain-scape taken in the Alps." />
            </div>
            <div class="wrapper">
                ...
                <div class="gallery">
                    <div class="controls">
                        <button class="button blur icon back">
                        ...
                        <button class="button blur icon toggle">
                            <svg class="play" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 viewBox="0 0 256 256">
                                <path
                            ...
                            <svg class="pause shown" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 viewBox="0 0 256 256">
                                <path
                        ...
                        <button class="button blur icon next">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256">
                                <path
                    ...
                    <div class="slides">
                        <div class="overflow">
                            @foreach ($photos as $photo)
                                <img @class(['active'=> $loop->first]) src="{{ $photo->url }}" alt="Gallery photo." />
                            @endforeach
                        </div>
                    </div>
                </div>
        ...
        <section id="about">
            <div class="wrapper">
                ...
                <img src="{{ Vite::asset("resources/images/ootm.png") }}" alt="Logo for Odyssey of the Mind International." />
            </div>
        </section>
        <section id="tagline">
            <div class="wrapper">
        ...
        <section id="testimonials">
            <div class="wrapper">
                ...
                <article>
                    ...
                    <div class="author">
                        <img src="{{ Vite::asset("resources/images/marcia.jpeg") }}"
