<x-layout.root title="Edit Event">
    <body class="form">
    <main id="edit-event">
        <div class="wrapper">
            <h2>Edit Event</h2>
            <form action="/office/events/edit?id={{$event->id}}" method="POST">
                @csrf
                <div class="group required">
                    <label for="title">Title</label>
                    <input required type="text" id="title" name="title" value="{{$event->title}}" />
                ...
                <div class="group required">
                    ...
                    <input required type="date" id="start" name="start" value="{{$event->start}}" />
                    <svg class="asterisk" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256">
                        <path
                            d="M211,103.43l-70.13,28,49.47,63.61a8,8,0,1,1-12.63,9.82L128,141,78.32,204.91a8,8,0,0,1-12.63-9.82l49.47-63.61L45,103.43A8,8,0,0,1,51,88.57l69,27.61V40a8,8,0,0,1,16,0v76.18l69-27.61A8,8,0,1,1,211,103.43Z"></path>
                    </svg>
                ...
                <div class="group">
                    ...
                    <textarea id="description" rows="5" name="description">{{$event->description}}</textarea>
                </div>
                <div class="group">
                ...
                <div class="submit">
                    <a class="button full" href="/office/events">
                        Cancel
