<x-layout.root title="Upload Photos">
    ...
    <main id="upload-photos">
        <div class="wrapper">
            <h2>Upload Photos</h2>
            <form action="/office/photos/new" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="dropzone">
                        <figure class="showcase">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256">
                                <path
                                    d="M240,136v64a16,16,0,0,1-16,16H32a16,16,0,0,1-16-16V136a16,16,0,0,1,16-16H80a8,8,0,0,1,0,16H32v64H224V136H176a8,8,0,0,1,0-16h48A16,16,0,0,1,240,136ZM85.66,77.66,120,43.31V128a8,8,0,0,0,16,0V43.31l34.34,34.35a8,8,0,0,0,11.32-11.32l-48-48a8,8,0,0,0-11.32,0l-48,48A8,8,0,0,0,85.66,77.66ZM200,168a12,12,0,1,0-12,12A12,12,0,0,0,200,168Z"></path>
                            </svg>
                        </figure>
                        <div class="details">
                            <ul>
                ...
                <div class="submit">
                    <a class="button full" href="/office/photos">
                        Cancel
