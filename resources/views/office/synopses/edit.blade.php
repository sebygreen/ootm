<x-layout.root title="Edit Synopsis">
    <body class="form">
    <main id="edit-synopsis">
        <div class="wrapper">
            <h2>Edit Synopsis</h2>
            <form action="/office/synopses/edit?id={{$synopsis->id}}" method="POST">
                @csrf
                    ...
                    <div class="select">
                        <select required name="year" id="year">
                            @foreach($range as $year)
                                <option value="{{ $year }}" @selected($synopsis->year === $year)>{{ $year }}</option>
                            @endforeach
                        </select>
                ...
                <div class="group required">
                    ...
                    <div class="links" id="links">
                        <input type="hidden" name="urls" id="urls" value="{{$synopsis->links}}">
                        <div class="form">
                            <div class="group required">
                ...
                <div class="checkbox">
                    ...
                    <label class="switch" for="shown">
                        <input type="checkbox" id="shown" name="shown" value="1" @checked($synopsis->shown) />
