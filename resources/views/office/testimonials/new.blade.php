<x-layout.root title="New Testimonial">
    <body class="form">
    <main id="new-testimonial">
        <div class="wrapper">
            <h2>New Testimonial</h2>
            <form action="/office/testimonials/new" method="POST">
                @csrf
                <div class="group required">
                    <label for="quote">Quote</label>
                    <textarea required id="quote" rows="5" name="quote"></textarea>
